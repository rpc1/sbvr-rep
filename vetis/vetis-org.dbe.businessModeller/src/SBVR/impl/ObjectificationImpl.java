...
public class ObjectificationImpl extends LogicalFormulationImpl implements Objectification {
		...
		if (logicalFormulation != null && logicalFormulation.eIsProxy()) {
			...
			if (logicalFormulation != oldLogicalFormulation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SBVRPackage.OBJECTIFICATION__LOGICAL_FORMULATION, oldLogicalFormulation, logicalFormulation));
			}
		}
	...
	public void setLogicalFormulation(LogicalFormulation newLogicalFormulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SBVRPackage.OBJECTIFICATION__LOGICAL_FORMULATION, oldLogicalFormulation, logicalFormulation));
	}
	...
	public BindableTarget getBindableTarget() {
		if (bindableTarget != null && bindableTarget.eIsProxy()) {
			...
			if (bindableTarget != oldBindableTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SBVRPackage.OBJECTIFICATION__BINDABLE_TARGET, oldBindableTarget, bindableTarget));
			}
		}
	...
	public void setBindableTarget(BindableTarget newBindableTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SBVRPackage.OBJECTIFICATION__BINDABLE_TARGET, oldBindableTarget, bindableTarget));
	}
