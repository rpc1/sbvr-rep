...
public class ModalFormulationImpl extends LogicalFormulationImpl implements ModalFormulation {
		...
		if (logicalFormulation != null && logicalFormulation.eIsProxy()) {
			...
			if (logicalFormulation != oldLogicalFormulation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SBVRPackage.MODAL_FORMULATION__LOGICAL_FORMULATION, oldLogicalFormulation, logicalFormulation));
			}
		}
	...
	public void setLogicalFormulation(LogicalFormulation newLogicalFormulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SBVRPackage.MODAL_FORMULATION__LOGICAL_FORMULATION, oldLogicalFormulation, logicalFormulation));
	}
