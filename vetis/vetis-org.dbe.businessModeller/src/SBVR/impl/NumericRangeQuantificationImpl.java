...
public class NumericRangeQuantificationImpl extends QuantificationImpl implements NumericRangeQuantification {
		...
		if (minimumCardinality != null && minimumCardinality.eIsProxy()) {
			...
			if (minimumCardinality != oldMinimumCardinality) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SBVRPackage.NUMERIC_RANGE_QUANTIFICATION__MINIMUM_CARDINALITY, oldMinimumCardinality, minimumCardinality));
			}
		}
	...
	public void setMinimumCardinality(NonNegativeInteger newMinimumCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SBVRPackage.NUMERIC_RANGE_QUANTIFICATION__MINIMUM_CARDINALITY, oldMinimumCardinality, minimumCardinality));
	}
	...
	public NonNegativeInteger getMaximumCardinality() {
		if (maximumCardinality != null && maximumCardinality.eIsProxy()) {
			...
			if (maximumCardinality != oldMaximumCardinality) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SBVRPackage.NUMERIC_RANGE_QUANTIFICATION__MAXIMUM_CARDINALITY, oldMaximumCardinality, maximumCardinality));
			}
		}
	...
	public void setMaximumCardinality(NonNegativeInteger newMaximumCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SBVRPackage.NUMERIC_RANGE_QUANTIFICATION__MAXIMUM_CARDINALITY, oldMaximumCardinality, maximumCardinality));
	}
...
} //NumericRangeQuantificationImpl
