 ...
 */
public class VocabularyMainEditorContributor extends MultiPageEditorActionBarContributor {
	 ...
	 */
	public VocabularyMainEditorContributor() {
		super();
		createActions();
	}
	...
	private void createActions() {
		parseAction = new Action() {
			public void run() {
				...
				VetisBmUtil.exportRulesToXmi(new File("C:/Documents and Settings/Algirdass/runtime-EclipseApplication/loan/Loan Contracts.voc"), new File("C:/Documents and Settings/Algirdass/runtime-EclipseApplication/loan/Loan Contracts.rules"), ResourceProvider.getFile("", "temp/sbvr.xmi"));
				
				//((VocabularyMainEditor)getPage().getActiveEditor()).parse();
			}
		};
		...
		contentAssistProposalAction = new RetargetTextEditorAction(VocabularyEditorMessages.getResourceBundle(), "ContentAssistProposal.");
	}
