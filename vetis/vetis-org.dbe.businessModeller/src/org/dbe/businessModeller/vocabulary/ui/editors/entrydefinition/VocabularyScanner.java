 ...
 */
/*
 * Modified 2009.06.15 by Vetis project
 */
...
import org.dbe.businessModeller.vocabulary.ui.editors.utils.VocabularyWordDetector;
import org.dbe.businessModeller.vocabulary.ui.editors.utils.VocabularyWordRule;
...
public class VocabularyScanner extends RuleBasedScanner {
	...
	public VocabularyScanner(VocabularyColorProvider provider) {
		this.provider = provider;
		IToken keyword= new Token(new TextAttribute(provider.getColor(VocabularyColorProvider.KEYWORD)));
		//IToken type= new Token(new TextAttribute(provider.getColor(VocabularyColorProvider.TYPE)));
		...
		VocabularyWordRule termRule = new VocabularyWordRule(new VocabularyWordDetector(), BusinessModellerPlugin.getDefault().getBMDictionary(), provider, other);
		...
		//regola per i Name
		VocabularyWordRule nameRule = new VocabularyWordRule(new VocabularyNameDetector(), BusinessModellerPlugin.getDefault().getBMDictionary(), provider, string);
