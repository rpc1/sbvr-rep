...
public class VocabularyEditorMessages {

	private static final String RESOURCE_BUNDLE= "vocabulary.ui.editors.VocabularyEditorMessages";

	private static ResourceBundle fgResourceBundle= ResourceProvider.getResourceBundle(RESOURCE_BUNDLE);

	private VocabularyEditorMessages() {
	}
