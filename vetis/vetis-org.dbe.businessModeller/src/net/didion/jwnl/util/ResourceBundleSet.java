...
//			BusinessModellerUtils.showMessage("Impossibile load the boundle: "+bundle+
//										"\nClassloader: "+classLoader);
//			return null;
//		}
		//return Platform.getResourceBundle(Platform.getBundle(bundle));
		//return ResourceProvider.getResourceBundle(bundle, _locale);
		return ResourceBundle.getBundle(bundle, _locale);
	}
}